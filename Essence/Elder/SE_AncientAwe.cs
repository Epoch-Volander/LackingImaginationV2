...

{
    public class SE_AncientAwe : StatusEffect
    {
        ...
        public static float m_baseTTL = Math.Min(LackingImaginationUtilities.xElderCooldownTime * LackingImaginationGlobal.c_elderAncientAweSED, LackingImaginationUtilities.xElderCooldownTime);
